...
PlotDOObsSimDiff <- function (indata, l_png = F, l_tif1 = F, cex_axis = 1.6, cex_lab = 1.6, cex_main = 1.6, n_height = 600, SiteCode, outfile = 'a1.png', start_date = as.POSIXct ('2013-01-01'), end_date = as.POSIXct ('2017-01-01') )
	{
	...
	Png ( pick1 = x, pick2 = y, outfile =  'DOObsSimDiff', n_height = n_height)
		...
		plot ( indata$date, indata$obs_sim, ylim = c ( min_y, max_y), col = 'gray30', pch = 3, type = 'n', lty = 2, xlab = x_label, ylab = 'DO (mg per litre)', cex.axis = cex_axis, cex.lab = cex_lab, cex.main = 1.6)
		abline (0,0)

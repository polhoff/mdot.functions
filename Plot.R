...
PlotDeficit_DODiff <- function ( c_indata )
	...
	PngOn()
		...
		plot ( indata$date, indata$DO_diff, col = 'gray30', pch = 3, type = 'n', lty = 2, xlab = 'Date (2013-04-25 to 2013-04-27)', ylab = 'Change in DO (mg per litre)', cex.axis = cex_axis, cex.lab = cex_lab, cex.main = 1.6, ylim = c ( min_y, max_y))
		points ( indata$date, indata$CSat, type = 'b', lty = 2,  col = 'gray85' ,lwd = 1, pch = 4, cex = 0.2  )
		...
		plot ( indata$date, indata$DO_deficit, ylim = c ( min_y, max_y), col = 'gray30', pch = 3, type = 'n', lty = 2, xlab = 'Date (2013-04-25 to 2013-04-27)', ylab = 'DO deficit (mg per litre)', cex.axis = cex_axis, cex.lab = cex_lab, cex.main = 1.6)
		points ( indata$date, indata$CSat, type = 'b', lty = 2,  col = 'gray85' ,lwd = 1, pch = 4, cex = 0.2  )
...
PlotPartitions <- function ( indata, l_png = F, l_tif1 = F, cex_axis = 1.6, cex_lab = 1.6, cex_main = 1.6, n_height = 600, outfile = 'O2_partitioned.png' )
	...
	PngOn (n_height = n_height)
		...
		plot ( indata$date, indata$Phot, ylim = c ( -0.06,0.06), pch = 1, type = 'b', lty = 2, xlab = 'Date', ylab = 'DO (mg per litre)', main = 'Component parts (simulated) of dissolved oxygen fluxes in river Ebble', cex.axis = cex_axis, cex.lab = cex_lab, cex.main = 1.6)
		
		points ( indata$date, indata$Gas, type = 'b', col = 'gray50' , pch = 3)
		points ( indata$date, indata$Resp, type = 'b', col = 'gray80', pch = 2)
...
PlotPartitionsHour <- function ( indata, l_png = F, l_tif1 = F, cex_axis = 1.6, cex_lab = 1.6, cex_main = 1.6, n_height = 600, outfile = 'O2_partitioned_hour.png' )
	...
	gas_hour <- aggregate ( indata[c ('Phot', 'Gas')], by = list (indata$date_hour), FUN = sum )
	...
	PngOn (n_height = n_height)
		...
		plot ( indata_agg$date, indata_agg$Phot, ylim = c ( min_y, max_y), pch = 1, type = 'b', lty = 3, xlab = 'Date', ylab = 'DO  flux (mg per litre per hour)', main = '', cex.axis = cex_axis, cex.lab = cex_lab, cex.main = 1.6)
		
		points ( indata_agg$date, indata_agg$Gas, type = 'b', col = 'gray50' , pch = 4, lty = 3)
		#points ( indata_agg$date, indata_agg$Resp, type = 'b', col = 'gray80', pch = 2)

		legend ( 'topleft', c ( 'Oxygen production flux','Aeration flux'), pch = c ( 1,4 ), cex = 1.6, col = c ( 'black','grey65'), lwd = c (2,2), lty = c (3,3), bty = 'n' )
		}
	PngOff()
	par (mfrow  = c (1,1))
	}
